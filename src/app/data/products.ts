...
export const products: Product[] = [
  /* ── 1 ── Дитяче ──────────────────────────────────────────────────────── */
  {
    ...
    tagline:
      "Найніжніше з можливого — оливкове кастильське мило для шкіри, яка ще все вчиться.",
    profile: {
    ...
    masterNote:
      "Перший рецепт, який повторюю кожного року — для подруги з малюком. Ставлю собі планку: щоб після цього мила немовляча шкіра була мʼякою, як перед сном.",
    detailedDescription:
  ...
  /* ── 2 ── Алепське ────────────────────────────────────────────────────── */
  {
    ...
    tagline:
      "Спадщина у бруску — оливкова основа з 25% олії благородного лавра.",
    profile: {
    ...
    masterNote:
      "Найдовше дозріває з усього, що я роблю — від 6 місяців до двох років. Чекати важко, але результат вартий: воно справді працює як ліки.",
    detailedDescription:
  ...
  /* ── 3 ── Екзотичне ───────────────────────────────────────────────────── */
  {
    ...
    tagline:
      "Пʼять базових і три цілющі олії — щоденна інвестиція у власну енергію.",
    profile: {
    ...
    masterNote:
      "Зварила це для себе — після особливо важкого тижня. Аромат пачулі та іланг-іланг дає те, що жоден кранч на роботі не дасть.",
    detailedDescription:
  ...
  /* ── 4 ── Лавандове ───────────────────────────────────────────────────── */
  {
    ...
    tagline:
      "Заспокійлива пауза перед сном — масло ші, фісташка та відвар лаванди.",
    profile: {
    ...
    keyIngredients: [
      { name: "Масло ші (каріте)", role: "живлення", tone: "honey" },
  ...
  /* ── 5 ── Медове ──────────────────────────────────────────────────────── */
  {
    ...
    tagline:
      "Тепла вуаль із меду, бджолиного воску й обліпихи — для шкіри, яка втомилася від зими.",
    profile: {
    ...
    keyIngredients: [
      ...
      { name: "Ефірні олії апельсину, ладану", role: "ароматерапія", tone: "rose" },
    ],
    masterNote:
      "Зварила вперше для подруги після пологів — у неї шкіра рук тріскала від частого миття. Тепер це наш найтепліший рецепт на холодний сезон.",
    detailedDescription:
  ...
  /* ── 6 ── Полин-шавлія-пижмо ──────────────────────────────────────────── */
  {
    ...
    tagline:
      "Травʼяний детокс-кокон — достатньо сильне, щоб очистити, і ніжне, щоб відновити.",
    profile: {
    ...
    masterNote:
      "Найризикованіша моя композиція — троє «гірких» трав. Але саме за цей різкий, степовий запах одне і те ж замовлення приходить третю партію поспіль.",
    detailedDescription:
  ...
  /* ── 7 ── Соляне ──────────────────────────────────────────────────────── */
  {
    ...
    tagline:
      "SPA-ефект у бруску — щільна шовковиста піна та морська сіль як ніжний пілінг.",
    profile: {
    ...
    masterNote:
      "Соляне — це коли треба прокинутися. Беру його в робочі дні; квітково-медові залишаю на вихідні.",
    detailedDescription:
  ...
  /* ── 8 ── Трояндове ───────────────────────────────────────────────────── */
  {
    ...
    tagline: "Делікатний ритуал краси з ароматом справжньої троянди.",
    profile: {
    ...
    masterNote:
      "На це мило йде найдорожча ефірна олія в майстерні. Намащую його на руки перед важливими розмовами — допомагає мені, можливо, допоможе і вам.",
    detailedDescription:
  ...
  /* ── 9 ── Квіткове ────────────────────────────────────────────────────── */
  {
    ...
    tagline:
      "Вишукане квіткове мило — обліпиха, абрикос, смарагдова глина й аромат нарциса з франжипані.",
    profile: {
    ...
    masterNote:
      "Найдорожча композиція ефірних олій — і єдина, де я не наполягаю на «корисності». Просто красиво пахне і робить ранок ритуалом.",
    detailedDescription:
  ...
  /* ── 10 ── Полуничне (з подорожником) ────────────────────────────────── */
  {
    ...
    tagline:
      "Ніжне мило-скраб — смарагдова глина та борошно подорожника для мʼякої ексфоліації.",
    profile: {
    ...
    masterNote:
      "Найʼдитячіший' з не-скрабів — за ароматом полуниці. Беру з собою у літню сумку, коли треба перемкнутися.",
    detailedDescription:
  ...
  /* ── 11 ── Набори ─────────────────────────────────────────────────────── */
  {
    ...
    tagline:
      "Дегустаційний набір або повноцінний подарунок — у натуральній упаковці.",
    masterNote:
      "Збираю набори вручну під кожне замовлення — підкажіть, для кого і для якого настрою, і знайду баланс брусків.",
    detailedDescription:
