        ...
        <div className="bg-white/85 rounded-3xl p-8 md:p-12 shadow-sm mb-12 border border-stone-100">
          ...
          <div className="flex flex-col md:flex-row flex-wrap justify-center gap-4">
            ...
            >
              ...
              <span className="font-medium text-lg md:text-base">Viber</span>
            </a>
            ...
            >
              ...
              <span className="font-medium text-lg md:text-base">WhatsApp</span>
            </a>
            ...
            >
              ...
              <span className="font-medium text-lg md:text-base">Facebook</span>
            </a>
