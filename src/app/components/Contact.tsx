...
export function Contact() {
  return (
    <section
      ...
      id="contact"
    >
      <div className="absolute inset-x-0 -top-12 -bottom-12 pointer-events-none opacity-[0.3]">
        <SoapWaveBg2 />
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <div className="bg-white/85 rounded-3xl p-8 md:p-12 shadow-sm mb-12 border border-stone-100">
          ...
          <div className="flex flex-col md:flex-row flex-wrap justify-center gap-4">
            <a
              href="viber://chat?number=%2B380966087578"
              className="relative overflow-hidden flex items-center justify-center gap-3 w-full md:w-auto bg-stone-50 text-stone-700 hover:text-white py-3.5 px-8 rounded-full border border-stone-200 shadow-sm hover:shadow-md transition-[color,box-shadow] duration-300 group"
            >
              <span
                ...
                style={{ background: "linear-gradient(to right, #657356, #657356 67%, transparent 100%)" }}
              />
              <span className="relative z-10 group-hover:scale-110 transition-transform">
                <ViberIcon size={22} />
              </span>
              <span className="relative z-10 font-semibold text-[11px] tracking-widest uppercase leading-none">Viber</span>
            </a>

            <a
              href="https://wa.me/380966087578"
              target="_blank"
            ...
            >
              ...
              <span className="relative z-10 font-semibold text-[11px] tracking-widest uppercase leading-none">WhatsApp</span>
            </a>

            <a
              href="https://www.facebook.com/t.dominichenko"
              target="_blank"
              rel="noopener noreferrer"
              className="relative overflow-hidden flex items-center justify-center gap-3 w-full md:w-auto bg-stone-50 text-stone-700 hover:text-white py-3.5 px-8 rounded-full border border-stone-200 shadow-sm hover:shadow-md transition-[color,box-shadow] duration-300 group"
            >
              ...
              <span className="relative z-10 font-semibold text-[11px] tracking-widest uppercase leading-none">Facebook</span>
            </a>

            <a
              href="https://www.instagram.com/_vele_slava/"
              target="_blank"
              rel="noopener noreferrer"
              className="relative overflow-hidden flex items-center justify-center gap-3 w-full md:w-auto bg-stone-50 text-stone-700 hover:text-white py-3.5 px-8 rounded-full border border-stone-200 shadow-sm hover:shadow-md transition-[color,box-shadow] duration-300 group"
            >
              ...
              <span className="relative z-10 font-semibold text-[11px] tracking-widest uppercase leading-none">Instagram</span>
            </a>
          </div>
        </div>
        </FadeIn>
